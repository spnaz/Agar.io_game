...
public class GearCircle extends Circle {
    ...
    public GearCircle(int x, int y, Color color, double radius) {
        super(x, y, color, radius);
    }

    public void updateAnimation() {
        this.angle += ANGLE_STEP * (((double) (getRadius() - (ServerEngine.GEAR_MAX_RADIUS + ServerEngine.GEAR_MIN_RADIUS) / 2)) / (ServerEngine.GEAR_MAX_RADIUS - ServerEngine.GEAR_MIN_RADIUS) * -0.8 + 1);
        this.angle %= 360;
