...
public class ClientConnection extends Thread {
    ...
    private ArrayList<ir.agar.Controller.PowerTypeResource> sentPowerTypes = new ArrayList<>();
    ...
    public void run() {
        ...
        if (tmpConnection) {
            ...
            while (true) {
                ...
                CopyOnWriteArrayList<ir.agar.Controller.PowerTypeResource> powerTypeResources = serverEngine.getPowerTypeResources();
                ArrayList<ir.agar.Controller.PowerTypeResource> newTypes = new ArrayList<>();

                for (ir.agar.Controller.PowerTypeResource ptr : powerTypeResources) {
